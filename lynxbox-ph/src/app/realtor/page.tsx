        ...
        >
          ...
          >
            ...
            <p style={{ 
              ...
              List Smarter. Get Seen Faster. Win More Deals
            </p>
            <p style={{ 
              ...
              Lynxbox PH gives Philippine realtors a searchable platform to showcase listings and connect with serious tenants — beyond Facebook groups and marketplaces.
            </p>
            ...
            >
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                ...
                <p style={{ fontSize: 'clamp(0.8rem, 2vw, 0.9rem)', opacity: 0.9, margin: 0 }}>
                  Get early access to our searchable listing platform
                </p>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '12px', width: '100%' }}>
                  ...
                  <div style={{ display: 'flex', gap: '8px', width: '100%' }}>
                    ...
                    />
                    <input type="hidden" name="source" value="realtor" />
        ...
        >
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ 
              ...
              Lynxbox PH is a digital listing platform designed to help realtors organize and promote rental properties in one professional, easy-to-share space. No clutter. No buried posts. Just clean, searchable listings that work.
            </p>
          </div>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <p style={{ color: '#4c5a6b', lineHeight: '1.6', margin: 0 }}>
                Create clean, organized property listings with photos, details, and location — all in one place
              </p>
            </div>
            ...
            <div style={{ 
              ...
              <p style={{ color: '#4c5a6b', lineHeight: '1.6', margin: 0 }}>
                Get your listings seen beyond Facebook posts and message threads
              </p>
            </div>
            ...
            <div style={{ 
              ...
              <h3 style={{ 
                ...
                Built for Realtor Partnerships
              </h3>
              <p style={{ color: '#4c5a6b', lineHeight: '1.6', margin: 0 }}>
                Showcase verified listings and build trust with tenants through a professional platform
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <div style={{ textAlign: 'center' }}>
            ...
            <p style={{ 
              ...
              We help realtors connect properties with the right tenants
            </p>
          </div>
            ...
            <div style={{ display: 'flex', gap: 'clamp(8px, 2vw, 12px)', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <p style={{ 
                  ...
                  Move your rental listings into a clean, organized digital platform that’s easy to update and share.
                </p>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: 'clamp(8px, 2vw, 12px)', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <p style={{ 
                  ...
                  Verified profiles help tenants feel confident engaging with your listings
                </p>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: 'clamp(8px, 2vw, 12px)', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <p style={{ 
                  ...
                  Search tools and filters help connect the right tenants to the right properties
                </p>
              </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: 'clamp(8px, 2vw, 12px)', alignItems: 'flex-start' }}>
              ...
              <div>
                ...
                <p style={{ 
                  ...
                  List and manage properties at no cost during our initial launch
                </p>
              </div>
            </div>
          </div>
        ...
        >
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            <h2 style={{ fontSize: 'clamp(1.5rem, 4vw, 2rem)', margin: 0 }}>
              Be Part of the First Realtor Partners on Lynxbox PH
            </h2>
            <p style={{ 
              fontSize: 'clamp(1rem, 2.5vw, 1.2rem)', 
              maxWidth: '600px',
              ...
              Help shape a better way to list and manage rentals in the Philippines
            </p>
            <p style={{ 
